  ...
  async onPageLoad() {
    ...
    form.addEventListener('submit', async (e) => {
      ...
      const storyData = {
        ...
        photo: photo, // Ini adalah File object
      ...
      if (navigator.onLine) {
        ...
        try {
          console.log('Online: Mengirim cerita ke API...');
          ...
          window.location.hash = '#/'; // Gunakan hash untuk SPA
        } catch (error) {
        ...
        // JIKA OFFLINE: Simpan ke IDB Outbox (Kriteria 4 Advanced)
        try {
          console.log('Offline: Menyimpan cerita ke Outbox IDB...');
